...
def H(state1, state2):
    ...
    spin_m = (state1[0], state2[0])
    spin_n = (state1[1], state2[1])
    spin_i = (state1[2], state2[2])
    spin_j = (state1[3], state2[3])
    spin_k = (state1[4], state2[4])
    spin_l = (state1[5], state2[5])
    ...
    term0 = 1 + (Sz_op(spin_m) * Sz_op(spin_n) * Sz_op(spin_i) * Sz_op(spin_j))
    if state1 == state2:
        vtx_type = 0
        allowed = True
        term = term0
